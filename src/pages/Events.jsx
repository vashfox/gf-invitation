                    ...
                    <div className="flex flex-col justify-center items-start gap-4">
                      <div className="w-[100%] flex text-right text-sm text-[#a47551] gap-4">
                        ...
                        <div className="flex-1 text-left">
                          {entourage.secondarySponsors.candle.map(
                            (item, idx) => (
                              <div
                                key={`men-${idx}`}
                                className="text-[#a47551] font-semibold"
          ...
          {homeVenue === "1" && (
            <>
              ...
              >
                <section className="bg-[#f9f5f0] py-6 px-2 rounded-xl">
                  <h2 className="pinyon-script-regular text-4xl sm:text-3xl font-bold text-center text-[#5e473b] mb-8">
                  You’re Invited! / Inaanyayahan Ka Namin!
                  </h2>
                  <div className="max-w-xl mx-auto space-y-2 gap-6">
                    <div className="flex-1 mb-10">
                      <h3 className="font-light text-sm text-center text-[#5e473b]">
Samahan mo kami sa isang simpleng salu-salo simula 4:30 PM
Magsuot ng pinaka-komportableng damit at maki-celebrate
sa bagong yugto ng aming buhay bilang mag-asawa.
                      </h3>
                    </div>
                  </div>

                  <img
                    src="./images/RLS-177.jpg"
                    alt="Background"
                    className="inset-0 w-full object-cover rounded-xl px-2"
                  />
                </section>
              </motion.div>
            </>
