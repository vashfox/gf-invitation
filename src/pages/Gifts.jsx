                ...
                >
                    ...
                    >
                        ...
                        <p className="text-gray-600 leading-relaxed">
                            With deep gratitude, your support will help us build our future — and give back to the ministry that helped shape our faith.    
                        </p>

                        {/* Arabic Dua */}
                        <div className="space-y-2">
                            <p className="font-arabic text-lg text-gray-800">
                            "Dako kaayo among pasalamat — hinaut nga balosan sa Ginoo ang inyong kaayo sa usa ka gatus ka pilo."
                            </p>
                            <p className="text-gray-600 italic text-sm">
                            We are deeply grateful — may the Lord return your kindness a hundredfold.
                            </p>
                        </div>
                    </motion.div>
