...
export default function Wishes() {
    ...
    const options = [
        { value: 'ATTENDING', label: 'Yes, I will be attending.' },
        { value: 'NOT_ATTENDING', label: 'Wishing I could be there, but I can\'t attend.' },
        { value: 'MAYBE', label: 'Not sure yet, I’ll let you know.' }
    ];
                        ...
                        <Marquee speed={20}
                            ...
                            {wishes.map((wish, index) => (
                                ...
                                >
                                    ...
                                    {/* Card content */}
                                    <div className="relative backdrop-blur-sm bg-white/80 p-4 rounded-xl border border-yellow-100/50 shadow-md">
                                        {/* Header */}
                ...
                >
                    ...
                    ${isSubmitting
                                ...
                                >
                                    ...
                                    <span>{isSubmitting ? 'Sending message...' : 'Send'}</span>
                                </motion.button>
                            </div>
                        </div>
                    </form>
